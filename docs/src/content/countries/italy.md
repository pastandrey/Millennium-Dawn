...
- **Traditional Education System** (neutral)
- **Southern Question** (neutral)
- **Brain Drain** (neutral)
- **Tax Evasion** (neutral)
- **Inefficent Administration** (neutral)
- **Inefficent Judicial System** (neutral)
- **Building Abuse** (neutral)
- **Unsustainable Pension System** (neutral)
- **Legacy of the PCI** (neutral)
- **Legacy of the MSI** (neutral)
- **RAI Lotting** (neutral)
- **Radio Radicale** (neutral)
- **Banned Nuclear Power** (neutral)
- **Ageing Population** (neutral)
- **Major Tourist Destination** (neutral)
- **Illegal Immigration from Africa** (neutral)
- **Reforms Expectance** (neutral)
- **The Mafia** (neutral)
- **NIMBY's Influence** (neutral)
