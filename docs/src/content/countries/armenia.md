...
- **Armenian Perseverance** (neutral)
- **Victory in the Karabakh war** (neutral)
- **Old Doctrine** (neutral)
- **High Level of Emigration** (neutral)
- **Huge Unemployment** (neutral)
- **Armenian Mafia** (neutral)
- **Gas and Electricity Suppply Problems** (neutral)
- **Lack of a Transaction System** (neutral)
