...
1.  If there are any portraits left over from deleting the old generals and admirals, move them to gfx\leaders\portrait_dump folder

1.  Once you've done a country, mark it with 'X' in the Generals_worksheet
